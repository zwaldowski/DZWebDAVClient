...
/**
 `MRDictionaryRequestOperation` is a subclass of `AFXMLRequestOperation` for downloading and working with XML response data as an NSDictionary.
 
 ## Acceptable Content Types
 
 By default, `MRDictionaryRequestOperation` accepts the following MIME types, which includes the official standard, `application/xml`, as well as other commonly-used types:
...
/**
 Creates and returns an `MRDictionaryRequestOperation` object and sets the specified success and failure callbacks.
